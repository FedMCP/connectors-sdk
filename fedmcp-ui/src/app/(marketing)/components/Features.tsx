...
export default function Features() {
  return (
    <section
      id="features"
      className="relative isolate mx-auto max-w-7xl overflow-hidden bg-gray-50 px-6 py-20 sm:py-28"
    >
      <div className="pointer-events-none absolute inset-y-0 left-1/2 -z-10 w-full -translate-x-1/2 transform bg-gradient-to-r from-indigo-100 via-transparent to-indigo-100 opacity-40" />
